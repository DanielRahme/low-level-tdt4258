...
#define GPIO_PA_BASE_c 0x40006000
#define GPIO_PA_SIZE_c ((GPIO_PA_BASE_c + GPIO_IFC_c) - GPIO_PA_BASE_c)

#define GPIO_PB_BASE 0x40006024

#define GPIO_PC_BASE_c 0x40006048
#define GPIO_PC_SIZE_c (GPIO_PC_PINLOCKN - GPIO_PC_BASE)

// GPIO A Offsets
#define GPIO_PA_CTRL_c     (0x00)
#define GPIO_PA_MODEL_c    (0x04)
#define GPIO_PA_MODEH_c    (0x08)
#define GPIO_PA_DOUT_c     (0x0c)
#define GPIO_PA_DOUTSET_c  (0x10)
#define GPIO_PA_DOUTCLR_c  (0x14)
#define GPIO_PA_DOUTTGL_c  (0x18)
#define GPIO_PA_DIN_c      (0x1c)
#define GPIO_PA_PINLOCKN_c (0x20)

#define GPIO_EXTIPSELL_c (0x100)
#define GPIO_EXTIPSELH_c (0x104)
#define GPIO_EXTIRISE_c  (0x108)
#define GPIO_EXTIFALL_c  (0x10c)
#define GPIO_IEN_c       (0x110)
#define GPIO_IFC_c       (0x11c)
